...
class bundled_scripts_and_styles {
	...
	function init(){
		...
		wp_register_script('lightbox',WPCSS_URL.'js/lightbox/jquery.lightbox.js',array('jquery'),'1.4.3');		

		$sws_plugin->add_script('lightbox','Lightbox Evolution','');			

		

		wp_register_script('preloadify',WPCSS_URL.'js/preloadify/jquery.preloadify.js',array('jquery','lightbox'),'1.0.2');		
