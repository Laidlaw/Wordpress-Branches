...
Description: This plugin allows you to create a lightbox with custom content in your site. You can customize the lightbox display by configuring various settings such as lightbox postion settings (height,width,top,left), display logic settings (time delay after page load, number of pages to browse, lightbox repeat interval) and style settings(z-index,overlay opacity, color, border etc). The plugin supports automatic and manual (shortcode) lightbox display.
Version: 1.1
