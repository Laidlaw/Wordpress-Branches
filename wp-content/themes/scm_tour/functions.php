...
if ( ! function_exists( 'scm_tour_setup' ) ) :
...
//include dirname(__file__) . '/inc/functions/backend/custom_pointer.php';
  ...
  register_nav_menus( array(
    'primary' => __( 'Primary Menu', 'scm_tour' ),
  ) );

}

endif; // scm_tour_setup
add_action( 'after_setup_theme', 'scm_tour_setup' );

/////////// Implement the Custom Header feature ////////////////
//require( get_template_directory() . '/inc/custom-header.php' );


function scm_tour_widgets_init() {
  register_sidebar( array(
    'name' => __( 'Sidebar', 'scm_tour' ),
    'id' => 'sidebar-1',
...
add_action( 'widgets_init', 'scm_tour_widgets_init' );


/////////////// Enqueue scripts and styles /////////////////

function scm_tour_scripts() {
  ...
  //wp_enqueue_script( 'socialCount', get_stylesheet_directory_uri() . '/inc/js/socialcount.js', array( 'jquery' ), '20120206', true );
  wp_enqueue_script( 'orbit', get_stylesheet_directory_uri() . '/inc/js/jquery.foundation.orbit.js', array( 'jquery' ), '20120206', true );
...
add_action( 'wp_enqueue_scripts', 'scm_tour_scripts' );
...
include dirname(__file__) . '/inc/functions/backend/admin_customizations.php';
