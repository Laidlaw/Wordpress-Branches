...
<div id="single_product_page_container" style="margin:auto; padding-top:0px;">
	...
	<div class="single_product_display group" style=" background-color:#FFF; border:10px solid #fff; height:auto; ">
<?php
		/**
		...
		while ( wpsc_have_products() ) : wpsc_the_product(); ?>
					...
					<div class="productcol">
                      <div id="tabs" style="width:500px; float:right">
                        ...
                        <span style="color: #333333; font-weight: normal; font-family: 'ProximaNovaRegular',Arial,sans-serif; font-size: 1.2em; letter-spacing: 1px; margin: 0 0 8px; text-transform: uppercase;"><?php echo wpsc_the_product_title(); ?> </span>
                        <form class="product_form" enctype="multipart/form-data" action="<?php echo wpsc_this_page_url(); ?>" method="post" name="1" id="product_<?php echo wpsc_the_product_id(); ?>" style="width:100%; float:left;">
						...
						<?php /** the variation group HTML and loop ends here */?>
                            ...
                            <div id="dots-border" style="margin-bottom:3px; width:100%; height: 5px "></div>
<div class="wpsc_product_qty">
                                <div class="wpsc_quantity_update" style="width:135px; float:left;">
								<p style="text-align: right; float: left; font-family: Arial,Helvetica,sans-serif; font-size: 12px; text-transform: uppercase; padding-top: 5px; padding-right: 15px;"><?php _e('Qty', 'wpsc'); ?>:&nbsp;</p>
								...
								<input type="hidden" name="wpsc_update_quantity" value="true" />
                                    ...
                                    <div class="wpsc_buy_button_container" style="width:160px; margin-right:22px; float:right;">
											...
											<?php else: ?>
										<input type="submit" value="<?php _e('', 'wpsc'); ?>" name="Buy" class="wpsc_buy_button" id="product_<?php echo wpsc_the_product_id(); ?>_submit_button" style="background-image:url(<?php  echo get_bloginfo('template_directory');   ?>/images/add_to_cart.png); border:0px; width:87px; height:23px; cursor:pointer; "/>
											<?php endif; ?>									
                                    </div><!--close wpsc_buy_button_container-->                                
                                    </div>
                             <div id="dots-border" style="margin-bottom:3px; width:100%; height: 1px "></div>
                                </fieldset>
							<?php endif ;?>
														<!--sharethis-->
                            ...
                            <li style="margin-left:0px;text-align:center;"><a href="#tabs-1">ITEM<br/>DESCRIPTION</a></li>
                            <li style="margin-left:0px;text-align:center;"><a href="#tabs-2">ADDITIONAL<br/>DETAILS</a></li>
                            <li style="margin-left:0px;text-align:center;"><a href="#tabs-3">PRODUCT<br/>GUARANTEE</a></li>
                        </ul>
...
<div class="addthis_toolbox addthis_default_style " style="width:213px; height:18px; float:left; margin-top:15px;">
...
<!--Footer Widget Start-->
<div id="bottom-side" style="margin-bottom:20px; width: 980px; padding-left:20px;">
