...
// FILES TO INCLUDE
include dirname(__file__) . '/functions/theme_hooks.php';
/*include dirname(__file__) . '/functions/custom_post_functions.php';
/*include dirname(__file__) . '/functions/admin_functions.php';*/
